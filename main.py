...
memes_api_tool = llm_utils.get_memes_api_tool()
agent_executor = llm_utils.get_entry_point(additional_tools=[memes_api_tool])

# Invoke with query related to memes api
# memes_output = agent_executor.invoke({"input": "Purchase quote #3"})
